! function (e, t) {
    ...
    new class {
        constructor() {
            this.apiHost = "/api/webar01/", this.isTurntableRunning = !1, this.userId = "", this.video = document.querySelector("#video"), this.isMiniprogram = !1, this.webAr = new i(1e3, "https://webar.easyar.com/webar/recognize.php"), this.checkWx(), this.pageFirst(), this.pageLottery(), this.pageContact()
        }
        checkWx() {
           ...
           // alert(e.meta);
            this.webAr.listCamera(t).then(i => {
                ...
                !s.isIos() && t.length > 1 && (n = t[t.length - 1].value), this.webAr.openCamera(this.video, n).then(t => {
                    ...
                    this.removeVideo(), e ? this.loadPackage() : (alert("打开摄像头失败11，请点击“立即体验”。"), this.toPage("pageFirst"))
                })
            }).catch(t => {
        ...
        loadPackage(e = null) {
            e || (e = {
               // model: "https://staticfile-cdn.sightp.com/easyar/webar/xiaoxiongmao.fbx",
                model:"/assets/js/xiaoxiongmao.fbx",
                scale: .13,
                isLoop: !0,
                position: [0, -7, 0],
